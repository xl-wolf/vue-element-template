...
Star.prototype = {
	...
	cache: function() {
		...
		this.cacheCtx.shadowColor = "cyan"
...
export function drawCanvas(domId) {
    ...
    setCanvasSize(dom)
	const canvasStar = new CanvasStar()
	canvasStar.init()
	dom.style.background = "linear-gradient(to bottom, #272626 0%, rgb(4, 8, 7) 100%)"

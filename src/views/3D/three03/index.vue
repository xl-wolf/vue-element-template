<template>
	<div class="app-main-container">
		...
		<i class="three03-container-ctrl iconfont" :class="`xl-icon-${paused ? 'pause' : 'start'}`" title="点击播放" @click="toggle" />

		<div id="three03-container-menu">
			<button v-for="{ label, id } in buttonArray" :key="id" :id="id">{{ label }}</button>
		</div>
	</div>
</template>
